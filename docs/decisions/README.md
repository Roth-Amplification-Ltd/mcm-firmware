...
| ADR | Decision |
|---|---|
| [0001](ADR-0001-spi-only-host-interface.md) | External host interface is SPI-only |
| [0002](ADR-0002-fixed-eight-byte-packets.md) | One fixed eight-byte packet per CS assertion |
...
| [0007](ADR-0007-deterministic-misra-like-native-profile.md) | Canonical deterministic MISRA-like native firmware profile |
